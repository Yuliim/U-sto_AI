...
# 1. 전체 물품 중 해당 물품이 선택될 확률 (총 20개 항목)
# 순서는 G2B_MASTER_DATA 리스트의 정의 순서와 일치해야 합니다.
# (노트북, 데스크톱, 모니터, 프린터, 스캐너, 라우터, HDD, 랙2000, 랙1800, 랙1200, 
#  책상, 의자, 책걸상, 칠판장, 화이트보드, 실습대, 실험대, 소파1, 소파2, 라운지의자)
ITEM_WEIGHTS = [
    0.180, 0.140, 0.220, 0.045, 0.020, 0.015, 0.012, 0.004, 0.004, 0.003, # IT (64.3%)
    0.040, 0.120, 0.065, 0.009, 0.007, 0.018, 0.015, 0.018, 0.015, 0.040  # 가구 (35.7%)
]
...
DEPT_WEIGHTS_BY_ITEM = {
    ...
    1: [0.20, 0.22, 0.08, 0.05, 0.15, 0.30], # 데스크톱
    2: [0.17, 0.20, 0.09, 0.07, 0.12, 0.35], # 모니터
    3: [0.14, 0.12, 0.08, 0.06, 0.15, 0.45], # 레이저프린터
    4: [0.12, 0.10, 0.08, 0.05, 0.20, 0.45], # 스캐너
    5: [0.03, 0.04, 0.01, 0.01, 0.85, 0.06], # 라우터
    6: [0.02, 0.03, 0.01, 0.01, 0.88, 0.05], # HDD
    7: [0.00, 0.01, 0.00, 0.00, 0.95, 0.04], # 랙 (2000mm)
    8: [0.00, 0.01, 0.00, 0.00, 0.95, 0.04], # 랙 (1800mm)
    9: [0.00, 0.01, 0.00, 0.00, 0.95, 0.04], # 랙 (1200mm)
    ...
    15: [0.20, 0.40, 0.10, 0.05, 0.20, 0.05], # 실습대
    16: [0.15, 0.45, 0.10, 0.05, 0.20, 0.05], # 실험대
    17: [0.05, 0.05, 0.10, 0.15, 0.10, 0.55], # 소파(1인)
    18: [0.05, 0.05, 0.10, 0.15, 0.10, 0.55], # 소파(2인)
    19: [0.05, 0.05, 0.10, 0.15, 0.10, 0.55], # 라운지용의자
}
# ---------------------------------------------------------
# 2. 데이터 생성 로직 (Phase 1)
# ---------------------------------------------------------
